    ...
    <div>
      ...
      <section className="border-b border-zinc-800 px-6 py-24 sm:py-32">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            ...
            <Link
              href="/services"
              className="rounded-md border border-zinc-600 px-6 py-3 text-sm font-medium text-white transition hover:border-zinc-500"
            >
              View services
            </Link>
          </div>
      ...
      <section className="px-6 py-20">
        <div className="mx-auto max-w-6xl">
          ...
          <ul className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {["Condo corporations", "Commercial property managers", "Multi-site portfolios"].map(
              (item) => (
                <li
                  key={item}
                  className="rounded-lg border border-zinc-800 bg-zinc-900/50 px-5 py-4 text-zinc-300"
                >
                  {item}
                </li>
              )
      ...
      <section className="px-6 py-20">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-4 max-w-2xl text-zinc-400">
            Cleaning, light maintenance, and site support tailored to your
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <Link
                key={href}
                href={href}
                className="block rounded-lg border border-zinc-800 bg-zinc-900/50 px-5 py-4 text-white transition hover:border-zinc-600"
              >
                {label}
              </Link>
            ))}
            ...
            {[
              {
                ...
                a: "We serve the Greater Toronto Area and can discuss other regions for multi-site portfolios.",
              },
              {
                q: "How is quality assured?",
                a: "Every job uses site-specific checklists. Completion evidence and photos are captured in our portal and available for your review.",
              },
              {
                q: "Who performs the work?",
                a: "Our network includes internal crews and vetted subcontractors. All are onboarded with compliance (COI, WSIB) and trained on your scope.",
              },
            ].map(({ q, a }) => (
              <div key={q}>
      ...
      <section className="px-6 py-24">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-zinc-400">
            Request a quote or book a site walk. We’ll respond within one
            business day.
          </p>
          <Link
            href="/contact"
            className="mt-8 inline-block rounded-md bg-white px-6 py-3 text-sm font-semibold text-zinc-900 transition hover:bg-zinc-200"
          >
            Contact us
          </Link>
        </div>
