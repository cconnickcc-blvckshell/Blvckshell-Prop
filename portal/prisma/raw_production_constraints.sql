-- Run this SQL AFTER your first Prisma migration has created the tables.
-- Use: Supabase SQL Editor, or psql, or Prisma migrate with an empty migration + this content.
-- These constraints cannot be expressed in Prisma schema and prevent data corruption.
